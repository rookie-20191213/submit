...
if __name__=='__main__':
    ...
    data=np.load('lab_init.npy')
    data=skimage.transform.resize(data,(100,400))
    data[:2,:]=1
    initial_model=data[:,select_index]
    pyplot.figure(figsize=(8,6))
    pyplot.rcParams.update({'font.size': 15})
    gci=pyplot.imshow(data,extent=(0,400,100,0),cmap=cm.gray_r,vmin=1,vmax=6)
    ax=pyplot.gca()
