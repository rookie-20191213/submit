...
if __name__=='__main__':
    ...
    gci=pyplot.imshow(data,extent=(0,400,75,0),cmap=cm.gray_r,vmin=-0.5e7,vmax=0.5e7)
    ax=pyplot.gca()
    ...
    pyplot.savefig('00_FieldExplosion.png',dpi=1000)
    
    # data=np.load('correlation_rtm_result.npy')
    # data=data[10:-10,10:-10]
    # pyplot.figure(figsize=(8,6))
    # pyplot.rcParams.update({'font.size': 15})
    # gci=pyplot.imshow(data,extent=(0,400,75,0),cmap=cm.gray_r,vmin=-1e10,vmax=1e10)
    # ax=pyplot.gca()
    # ax.set_xticks(np.linspace(0,400,5))
    # ax.set_xticklabels([0,2,4,6,8])
    # ax.set_yticks(np.linspace(0,75,4))
    ...
    # cbar.set_label('Amplitude')
    # cbar.formatter.set_powerlimits((-1, 1))
    # # pyplot.savefig('01_FieldCorrelationResult.png',dpi=1000)
    ...
    # cbar.set_label('Amplitude')
    # cbar.formatter.set_powerlimits((-1, 1))
    # # pyplot.savefig('02_FieldCorrelationSource.png',dpi=1000)
    ...
    # cbar=pyplot.colorbar(gci,cax=cax)
    # cbar.set_label('Amplitude')
    # pyplot.savefig('03_FieldCorrelationReceiver.png',dpi=1000)