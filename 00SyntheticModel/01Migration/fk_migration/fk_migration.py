...
if __name__=='__main__':
    ...
    profile=np.load('./forward_without_air.npy')-np.load('direct.npy')
    s_time=time.time()
    FM_=FM_Migration(dx=0.02, dt=4e-11*1500/profile.shape[0], epsilon=ep_rms)
    ...
    pyplot.savefig('00_FKMigration.png',dpi=1000)
